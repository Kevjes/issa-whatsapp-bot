/**
 * Workflow: Collecte du Nom (Onboarding)
 * Premier workflow déclenché pour tout nouvel utilisateur
 * Architecture: Domain Layer (Clean Architecture)
 */

import { WorkflowDefinition } from '../types/workflow';

export const nameCollectionWorkflow: WorkflowDefinition = {
  id: 'name_collection',
...
(J'aime bien savoir avec qui je discute, ça rend la conversation plus conviviale 😉)`,
      ...
      metadata: {
        skipValidation: true // Juste afficher le message
      }
    },
    {
      id: 'await_name_input',
...
Comment puis-je vous aider aujourd'hui ?`,
  ...
  transitions: [
    // Transition automatique : pas de conditions, suit le nextState
  ],
  metadata: {
    category: 'onboarding',
    priority: 100, // Priorité maximale - doit être exécuté en premier
    mandatory: true, // Ce workflow est obligatoire pour les nouveaux utilisateurs
